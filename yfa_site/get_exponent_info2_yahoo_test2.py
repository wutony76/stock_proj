...
def start_get_yahoo_exponent_infos():
  ...
  test_url = "https://vjzsqsxgaqq5tdfimnzcmg-on.drv.tw/TEST_html/twse01_1000.html"
  out = start_get_exponent_info(out, test_url)
...
def start_get_exponent_info( out, yahoo_url ):
  ...
  _data.strip()
  #print( "tick = ",_data.index('"tick"', 1000) )
  t_index = _data.index('"tick"', 1000)
  s_t = t_index
  ...
  print( "d=",_data)
  #print( _data[0:3]  )
  #print( _data[len(_data)-3:len(_data)]  )
